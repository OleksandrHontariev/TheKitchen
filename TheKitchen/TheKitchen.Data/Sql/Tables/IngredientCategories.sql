CREATE TABLE IngredientCategories(
	...
	ParentCategoryId int NULL CONSTRAINT FK_IngredientCategories_ParentCategoryId_IngredientCategories_Id FOREIGN KEY REFERENCES IngredientCategories(Id) ON DELETE NO ACTION,
