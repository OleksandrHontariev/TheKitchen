CREATE TABLE Ingredients (
	...
	IngredientCategoryId int NULL CONSTRAINT FK_Ingredients_IngredientCategoryId_IngredientCategories_Id FOREIGN KEY REFERENCES IngredientCategories(Id) ON DELETE NO ACTION,
