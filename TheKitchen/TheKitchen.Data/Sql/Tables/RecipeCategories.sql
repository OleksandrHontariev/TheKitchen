CREATE TABLE RecipeCategories (
	...
	ParentRecipeCategoryId int NULL CONSTRAINT FK_RecipeCategories_ParentRecipeCategoryId_RecipeCategories_Id FOREIGN KEY REFERENCES RecipeCategories(Id) ON DELETE NO ACTION,
